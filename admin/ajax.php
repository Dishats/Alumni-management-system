...
// New actions for notices
if ($action == "save_notice") {
    $save = $crud->save_notice();
    if ($save) {
        echo json_encode(['status' => 'success', 'message' => 'Notice saved successfully!', 'id' => $save]);
    } else {
        echo json_encode(['status' => 'error', 'message' => 'Failed to save notice.']);
    }
}
